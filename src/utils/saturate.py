...
class saturate:
    ...
    def __init__(self, model_or_params: Union[Module, Iterable[Parameter]], infinity: float = 1000):
...
class masked_saturate:
    ...
    def __init__(self, params: Iterable[Parameter], masks: Iterable[Parameter], infinity: float = 1000):
